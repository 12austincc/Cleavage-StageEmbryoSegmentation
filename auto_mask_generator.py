...
class SamAutomaticMaskGenerator:
    ...
    def _process_batch(
        ...
        data["stability_score"] = calculate_stability_score(
            data["masks"], self.predictor.model.sam.mask_threshold, self.stability_score_offset
        )
        ...
        data["masks"] = data["masks"] > self.predictor.model.sam.mask_threshold
...
#     # i = ImageEncoderViT()
#     # t = TwoWayTransformer(1,1,1,1)
#     # m = MaskDecoder(transformer_dim=1,transformer=t)
#     # p = PromptEncoder(1,[1,1],[1,1],1)
